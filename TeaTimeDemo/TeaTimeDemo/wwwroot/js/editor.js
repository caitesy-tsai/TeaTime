...
function initializeTinyMCE() {
    tinymce.init({
        ...
        toolbar: 'undo redo | formatselect | bold italic backcolor | code | table | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | removeformat',
    ...
    var questionHtml = `
        <div class="border p-2 my-3 question-container" id="question-${questionIndex}">
            ...
            <div class="mb-3">
                ...
                <input name="QuestionVMs[${questionIndex}].Question.QuestionText" class="form-control" oninput="updateMceContent()" />
            </div>
            <div class="mb-3">
